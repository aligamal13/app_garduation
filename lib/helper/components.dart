...
Widget defultTextFormFild(context,{
  ...
  bool isClicble=true,
    ...
    TextFormField(
      ...
      decoration: InputDecoration(
        labelText: labelText,labelStyle: Theme.of(context).textTheme.bodyLarge,
        hintText: labelText,hintStyle: Theme.of(context).textTheme.bodyLarge,
        filled: true,
...
void navgiTo(context, Widget screen)=>Navigator.push(context,
    MaterialPageRoute(builder:
        (context)=>screen,
    ));

void navgiToAndFinsh(context, screen)=>Navigator.pushAndRemoveUntil(context,
    MaterialPageRoute(builder:
        (context)=>screen,
    ),
